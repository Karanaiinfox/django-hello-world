...
def login(request):
    ...
    hubspot_auth_url = (
        f"https://app.hubspot.com/oauth/authorize?client_id={HUBSPOT_CLIENT_ID}"
        f"&redirect_uri={HUBSPOT_REDIRECT_URI}&scope=crm.schemas.companies.write%20crm.schemas.contacts.write%20crm.schemas.deals.read%20crm.schemas.deals.write%20automation%20crm.schemas.orders.write%20crm.schemas.orders.read%20crm.objects.orders.write%20oauth%20crm.objects.orders.read%20crm.objects.contacts.write%20e-commerce%20crm.objects.companies.write%20automation.sequences.enrollments.write%20automation.sequences.read%20crm.objects.companies.read%20crm.schemas.contacts.read%20crm.objects.deals.write%20crm.objects.contacts.read%20crm.schemas.companies.read&optional_scope=crm.export%20crm.dealsplits.read_write%20crm.import%20crm.lists.write%20crm.lists.read"
    )
...
def callback(request):
    ...
    if response.status_code == 200:
        ...
        print('redirecting to asana------------')
        return redirect('/asana')
    else:
